...
const InGameCustomizationModal: React.FC<InGameCustomizationModalProps> = ({ isOpen, onClose, character, onSave, reason }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-stone-900 border border-stone-700 rounded-lg w-full max-w-2xl m-4 text-white flex flex-col max-h-[90vh] animate-fade-in"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="p-6 border-b border-stone-800">
            <h2 className="text-2xl font-bold">Edit Appearance</h2>
            <p className="text-sm text-stone-400 mt-1">{reason}</p>
        </div>
